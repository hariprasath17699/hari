...
void QtAddressBookGUI::createWidgets()
{
    ...
    editContactButton->setStyleSheet("padding : 05px;border-radius:2%;background-color: green;color:white");
    deleteContactButton->setStyleSheet("padding : 05px;border-radius:2%;background-color: blue;color:white");
